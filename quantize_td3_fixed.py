"""
Quantize TD3 actor using custom weights-only INT8 quantization.
...
class QuantizedLinear(nn.Module):
    """Custom quantized linear layer with INT8 weights and FP32 activations."""
...
def load_models(model_path='models/TD3_64_64/1500.zip'):
    ...
    quantized_policy = quantize_model_weights(policy)
...
def main():
    ...
    fp32_time, fp32_std = measure_power_usage(fp32_policy)
    quantized_time, quantized_std = measure_power_usage(quantized_policy)
