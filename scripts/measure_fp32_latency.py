...
actor_path = pathlib.Path('models/policies/actor_fp32_32_32.pt')
states_path = pathlib.Path('states_eval.npy')

if not actor_path.exists():
    raise SystemExit('missing actor_fp32_32_32.pt')
...
output_path = results_dir / 'fp32_latency.json'
