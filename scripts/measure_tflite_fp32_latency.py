...
def main() -> int:
    parser = argparse.ArgumentParser(description="Measure FP32 TFLite latency.")
    parser.add_argument("--model-path", type=str, default="tflite_actors/model_fp32.tflite")
    ...
    parser.add_argument("--output-path", type=str, default="results/tflite_fp32_latency.json")
    parser.add_argument(
    ...
    sample = states[0:1].reshape(locked_shape)
